...
declare class DeviceController {
   ...
   **/
    ...
    **/
     ...
     *   }
    **/
    details(req: IRequest, res: IResponse, next: NextFunction): Promise<void>;
    /**
    ...
    **/
     ...
     */
    dropDownListByRestaurant(req: IRequest, res: IResponse, next: NextFunction): Promise<void>;
    /**
     ...
     */
    deviceData(req: IRequest, res: IResponse, next: NextFunction): Promise<void>;
}
